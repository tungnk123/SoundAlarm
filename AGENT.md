...
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --platform android -n 5

# Code snippets (copy-paste Kotlin/Compose templates)
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --domain snippet -n 3

# Gradle dependencies (ready-to-paste declarations)
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --domain gradle -n 5

# Architecture patterns
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --domain architecture

# Anti-patterns filtered for Android
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --domain antipattern --filter-platform android

# Performance rules filtered for Android
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --domain performance --filter-platform android

# Stack-specific search
python3 ~/.mobile-best-practices/scripts/search.py "<keyword>" --stack compose
```
...
python3 ~/.mobile-best-practices/scripts/search.py "viewmodel repository" --domain snippet -n 3

# 2. Get Gradle dependencies needed
python3 ~/.mobile-best-practices/scripts/search.py "hilt room retrofit" --domain gradle -n 5

# 3. Get Android-specific best practices
python3 ~/.mobile-best-practices/scripts/search.py "compose state hilt" --platform android -n 5

# 4. Check anti-patterns to avoid
python3 ~/.mobile-best-practices/scripts/search.py "android compose" --domain antipattern --filter-platform android

# 5. Get architecture guidance
python3 ~/.mobile-best-practices/scripts/search.py "mvvm clean architecture" --domain architecture

# 6. Check performance rules
python3 ~/.mobile-best-practices/scripts/search.py "compose recomposition lazy" --domain performance --filter-platform android
```
...
```bash
python3 ~/.mobile-best-practices/scripts/search.py "viewmodel compose screen" --domain snippet -n 3
python3 ~/.mobile-best-practices/scripts/search.py "coil paging compose" --domain gradle -n 5
python3 ~/.mobile-best-practices/scripts/search.py "lazy list image performance" --platform android -n 3
python3 ~/.mobile-best-practices/scripts/search.py "product list card" --domain ui --filter-platform android
```

### New Project: "Build an e-commerce app"

```bash
python3 ~/.mobile-best-practices/scripts/search.py "e-commerce" --domain reasoning
python3 ~/.mobile-best-practices/scripts/search.py "mvvm clean architecture android" --domain architecture
python3 ~/.mobile-best-practices/scripts/search.py "viewmodel repository hilt" --domain snippet -n 5
python3 ~/.mobile-best-practices/scripts/search.py "room navigation theme" --domain snippet -n 5
python3 ~/.mobile-best-practices/scripts/search.py "compose hilt room retrofit" --domain gradle -n 10
python3 ~/.mobile-best-practices/scripts/search.py "android architecture" --domain antipattern --filter-platform android
python3 ~/.mobile-best-practices/scripts/search.py "compose startup image" --domain performance --filter-platform android
```

### Code Review: "Review my Android code"

```bash
python3 ~/.mobile-best-practices/scripts/search.py "android compose viewmodel" --domain antipattern -n 5
python3 ~/.mobile-best-practices/scripts/search.py "state recomposition lifecycle" --platform android -n 5
python3 ~/.mobile-best-practices/scripts/search.py "compose lazy image startup" --domain performance --filter-platform android
python3 ~/.mobile-best-practices/scripts/search.py "android storage encryption api key" --domain security --filter-platform android
```

### Gradle Setup: "What dependencies do I need?"

```bash
python3 ~/.mobile-best-practices/scripts/search.py "compose material3 bom" --domain gradle -n 5
python3 ~/.mobile-best-practices/scripts/search.py "hilt room retrofit" --domain gradle -n 5
python3 ~/.mobile-best-practices/scripts/search.py "navigation coil paging" --domain gradle -n 5
python3 ~/.mobile-best-practices/scripts/search.py "testing junit mockk turbine" --domain gradle -n 5
```
